...
const AddTourismPackage = () => {
    ...
    const savePackage = (e) => {
        ...
        const tourismPackage = { name, description, price, duration, destination };

        tourismPackageService.addPackage(tourismPackage)
            .then((response) => {
    ...
    return (
        <div className="container">
            <form className="forms">
                ...
                <button onClick={savePackage}>Submit</button>
            </form>
        </div>
    );
};

export default AddTourismPackage;
